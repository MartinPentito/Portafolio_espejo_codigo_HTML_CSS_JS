(function () {
    ...
    function getWebGLContext(canvasElement) {
        ...
        if (!isWebGL2) glContext = canvasElement.getContext('webgl', params) || canvasElement.getContext('experimental-webgl', params);
    ...
    function supportRenderTextureFormat(glContext, internalFormat, format, type) {
        ...
        return glContext.checkFramebufferStatus(glContext.FRAMEBUFFER) === glContext.FRAMEBUFFER_COMPLETE;
    }
    ...
    function buildPrograms() {
        ...
        blit = function (target, clear = false) {
            if (target == null) {
